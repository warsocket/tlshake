...
#auxilarry fnction so we only ahve to define our lookup lists once
...
tls_serverhello_contenttype = {
21 : 'Alert',
22 : 'ServerHello',
}
rev_tls_serverhello_contenttype = rev(tls_serverhello_contenttype)


tls_versions = {
# '\x7f\x00' : 'TLSv1.3draft0',
# '\x7f\x01' : 'TLSv1.3draft1',
# '\x7f\x02' : 'TLSv1.3draft2',
# '\x7f\x03' : 'TLSv1.3draft3',
# '\x7f\x04' : 'TLSv1.3draft4',
# '\x7f\x05' : 'TLSv1.3draft5',
# '\x7f\x06' : 'TLSv1.3draft6',
# '\x7f\x07' : 'TLSv1.3draft7',
# '\x7f\x08' : 'TLSv1.3draft8',
# '\x7f\x09' : 'TLSv1.3draft9',
# '\x7f\x0a' : 'TLSv1.3draft10',
# '\x7f\x0b' : 'TLSv1.3draft11',
# '\x7f\x0c' : 'TLSv1.3draft12',
# '\x7f\x0d' : 'TLSv1.3draft13',
# '\x7f\x0e' : 'TLSv1.3draft14',
# '\x7f\x0f' : 'TLSv1.3draft15',
# '\x7f\x10' : 'TLSv1.3draft16',
# '\x7f\x11' : 'TLSv1.3draft17',
# '\x7f\x12' : 'TLSv1.3draft18',
...
rev_tls_versions = rev(tls_versions)
...
'\x13\x01': 'TLS13_AES_128_GCM_SHA256',
'\x13\x02': 'TLS13_AES_256_GCM_SHA384',
'\x13\x03': 'TLS13_CHACHA20_POLY1305_SHA256',
'\x13\x04': 'TLS13_AES_128_CCM_SHA256',
'\x13\x05': 'TLS13_AES_128_CCM_8_SHA256',
# '\x56\x00' : 'TLS_FALLBACK_SCSV',
...
'\xCC\xAA' : 'TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256',
'\xCC\xAB' : 'TLS_PSK_WITH_CHACHA20_POLY1305_SHA256',
'\xCC\xAC' : 'TLS_ECDHE_PSK_WITH_CHACHA20_POLY1305_SHA256',
'\xCC\xAD' : 'TLS_DHE_PSK_WITH_CHACHA20_POLY1305_SHA256',
'\xCC\xAE' : 'TLS_RSA_PSK_WITH_CHACHA20_POLY1305_SHA256',
}
rev_tls_ciphers = rev(tls_ciphers)
